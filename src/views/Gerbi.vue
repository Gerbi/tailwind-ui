      ...
      <div class="container mx-auto flex items-center justify-between py-2">
        <div>
          <a href="//telegram.org/" class="text-tgblue">
            <svg height="32" viewBox="0 0 133 34" width="133" xmlns="http://www.w3.org/2000/svg">
...
<!--        <router-link to="/gerbi" class="text-blue-600">-->
<!--          <img class="h-122 w-122 bg-cover rounded-full text-center" src="https://cdn1.telesco.pe/file/gFkaA3nUuuAa6g35Njoq8kE_xonhwjlM3pUiFILK1uBxKruFTRCXaUefhfvR7UqDZK7LJ3woA4EJqsjCNjmVImozWyB5GAwRcq87MAPvHDAn6xDgQTWaMWsYFIACkXvRyusecMk8ca3OSUheOJoNCp1jzYEOm7RFsZE8dI_NOuPj8Rtz9YziAuhmYPwbuypv1ZadyAlRoqtPf388DPWK2QY1sbgdWDw7y6Gv89cT9jl222r0FgjEyDbxq6bLvtVlAmcyRHV7JWlhGJgBjfFy7UEIncT2UrIR3sBHLD9sgF1JEW1_fsqA6mfgYFg4vpuCT1s0ohI9oaVpgEBYRp69_A.jpg"></router-link>-->
<!--          <img class="h-122 w-122 bg-cover rounded-full text-center" src="https://cdn1.telesco.pe/file/gFkaA3nUuuAa6g35Njoq8kE_xonhwjlM3pUiFILK1uBxKruFTRCXaUefhfvR7UqDZK7LJ3woA4EJqsjCNjmVImozWyB5GAwRcq87MAPvHDAn6xDgQTWaMWsYFIACkXvRyusecMk8ca3OSUheOJoNCp1jzYEOm7RFsZE8dI_NOuPj8Rtz9YziAuhmYPwbuypv1ZadyAlRoqtPf388DPWK2QY1sbgdWDw7y6Gv89cT9jl222r0FgjEyDbxq6bLvtVlAmcyRHV7JWlhGJgBjfFy7UEIncT2UrIR3sBHLD9sgF1JEW1_fsqA6mfgYFg4vpuCT1s0ohI9oaVpgEBYRp69_A.jpg"></router-link>-->
<!--      </div>-->
